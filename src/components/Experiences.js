    ...
    const experiences = {
        Johnson: {
            ...
            description: [
                ...
                "•  Atuei como SDET, colaborando com um time multidisciplinar para garantir a qualidade da entrega por meio da criação e execução de testes manuais e automatizados. Desenvolvi cenários de teste para as principais funcionalidades de portais da empresa no setor de logística. Experiência em automação de testes utilizando Cypress, além de conhecimento em integração contínua e deploy contínuo. Realizei análise de defeitos, garantindo o funcionamento adequado do produto e seguindo boas práticas de qualidade durante todo o ciclo de entrega.",
